            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="text-gray-400 transition-colors duration-200 hover:text-green-700"
              ...
              <ul className="space-y-2">
                {section.links.map((link) => (
                  <li key={link.name}>
                    <a
                      href={link.href}
                      className="text-sm text-gray-300 transition-colors duration-200 hover:text-green-700"
                    >
                      {link.name}
                    </a>
                  </li>
